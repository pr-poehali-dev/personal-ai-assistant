...
✅ Анализировать изображения, фото и скриншоты
...
Объясни что для генерации нужно написать "нарисуй [описание]" - тогда система автоматически создаст картинку."""
        ...
        is_video_file = '[Пользователь прикрепил ВИДЕО' in message or '[Пользователь прикрепил видео' in message
        
        if has_file_mention and image and is_video_file:
            system_instructions += "\n\n🎬 ВИДЕО ФАЙЛ! Пользователь записал или загрузил видео. Ты получил кадр из этого видео + информацию об аудио. Дай ПОЛНЫЙ анализ: что видно на видео, что слышно в аудио, общая оценка."
