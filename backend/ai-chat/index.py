...
✅ Анализировать аудио: технические параметры + музыкальные характеристики + распознавание речи (если есть)
...
- Оценивать мелодию или гармонию (только частотный баланс)
