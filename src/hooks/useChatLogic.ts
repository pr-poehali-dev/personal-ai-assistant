        ...
        if (fileToSend) {
          if (fileToSend.type.startsWith('image/')) {
            ...
            try {
              ...
              await new Promise<void>((resolve, reject) => {
                ...
                videoElement.onseeked = () => {
                  ...
                  if (ctx) {
                    ...
                    fileInfo = `[Пользователь прикрепил видео: ${fileToSend.name}, длительность: ${Math.round(videoElement.duration)}с] `;
                  }
              ...
              fileInfo = `[Пользователь прикрепил видео: ${fileToSend.name}, не удалось извлечь кадр] `;
            }
          } else {
